...
su -s /bin/bash hdfs -c "hadoop fs -mkdir /tmp/mapred"
su -s /bin/bash hdfs -c "hadoop fs -mkdir /tmp/mapred/system"
su -s /bin/bash hdfs -c "hadoop fs -chmod 755 /tmp/mapred/system"
su -s /bin/bash hdfs -c "hadoop fs -chown -R mapred:hadoop /tmp/mapred"
su -s /bin/bash hdfs -c "hadoop fs -mkdir -p /var/log/hadoop-yarn"
su -s /bin/bash hdfs -c "hadoop fs -chown yarn:mapred /var/log/hadoop-yarn"
